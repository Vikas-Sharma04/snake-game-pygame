...
class MAIN:
    ...
    def create_walls(self):
        walls = []
        for x in range(0, int(cell_number/2)-1):
            walls.append(Vector2(5, cell_number-x))  # Left wall
            walls.append(Vector2(cell_number - 5,cell_number- x))  # Right wall
        for y in range(1, int(cell_number/2)-1):
            walls.append(Vector2(5, y))  # Left wall
            walls.append(Vector2(cell_number - 5, y))  # Right wall
        return walls
    ...
    def level_up(self):
        ...
        import level5
        level5.main(current_score, self.speed)  # Pass the score and speed increment
        return
