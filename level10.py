...
class MAIN:
    ...
    def create_walls(self):
        ...
        for x in range(3, 7):
            ...
            walls.append(Vector2(cell_number-x-1,3)) #top wall
            walls.append(Vector2(x, cell_number - 3))
            walls.append(Vector2(cell_number-x-1, cell_number - 3)) #bottom wall  
        for x in range(2, 18):
            walls.append(Vector2(x, 10)) 
        for y in range(3, 7):
            walls.append(Vector2(2, y))
            walls.append(Vector2(2, cell_number-y))    # Left wall
            walls.append(Vector2(cell_number - 3, y))
            walls.append(Vector2(cell_number - 3, cell_number-y))  # Right wall
        return walls
    ...
    def level_up(self):
        ...
        import level1
        level1.main(current_score, self.speed)  # Pass the score and speed increment
        return
