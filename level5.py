...
class MAIN:
    ...
    def create_walls(self):
        walls = []
        for x in range(0, cell_number-5):
            walls.append(Vector2(x,4)) # Left wall
            walls.append(Vector2(cell_number- x,cell_number - 4))  # Right wall
        for y in range(0, int(cell_number/2)-1):
            walls.append(Vector2(cell_number-y,10)) 
            walls.append(Vector2(y,cell_number - 10))  # Right wall
        return walls
    ...
    def level_up(self):
        ...
        import level6
        level6.main(current_score, self.speed)  # Pass the score and speed increment
        return
