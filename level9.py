...
class MAIN:
    ...
    def create_walls(self):
        ...
        for x in range(0, 4):
            ...
            walls.append(Vector2(cell_number-x-1,1)) 
            walls.append(Vector2(x, cell_number - 1))
            walls.append(Vector2(cell_number-x-1, cell_number - 1))
        for x in range(2, 18):
            walls.append(Vector2(x, 7)) 
            walls.append(Vector2(x, 13)) 

        for y in range(2, 5):
            walls.append(Vector2(0, y))
            walls.append(Vector2(0, cell_number-y))    # Left wall
            walls.append(Vector2(cell_number - 1, y))
            walls.append(Vector2(cell_number - 1, cell_number-y))  # Right wall
        return walls
    ...
    def level_up(self):
        ...
        import level10
        level10.main(current_score, self.speed)  # Pass the score and speed increment
        return
